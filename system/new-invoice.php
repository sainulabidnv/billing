                ...
                <div class="col-md-2">
                    <div class="form-group ">
                        ...
                        <div class="input-group date mdate" id="tsn_date">
                            <input type="text" class="form-control required" name="tsn_date" value="<?php echo $siteConfig['date'];  ?>" data-date-format="<?php echo $siteConfig['dformat2']; ?>"/>
            ...
            <div class="panel panel-primary">
                ...
                <div id="bill_totl" class="panel padding-b">
                    ...
                    <div class="row margin-bottom padding">
                        ...
                        <div class="col-xs-4 text-right">
                            <div class="input-group">
                                <input type="number" class="form-control jod vvt" name="invoice_vvt" placeholder="Discount" value="0">
