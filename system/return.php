 ...
 * ***********************************************************************
 */
if (stristr(htmlentities($_SERVER['PHP_SELF']), "return.php")) {
...
function create()
{
    ...
    {
        global $db;
        $row = $db->select('returnc', null, null, 'ORDER BY tid DESC')->results();
        if ($row) {
            echo $row['tid'] + 1;
        }
    }
    ...
    <a href="#" class="btn btn-danger btn-xs delete-row" title="Delete Product row"><span
                ...
                <div class="col-xs-12 col-md-6 col-lg-1 mol-1">
                    <input type="text" class="form-control saman_qty jod required" id="saman_qty[]" name="saman_qty[]"
                           value="">
                </div>
    ...
    <span class="input-group-addon currenty"><?php
        ...
        ?></span>
                        <input type="text" class="form-control jod billsaman_price required" name="billsaman_price[]"
                               placeholder="0.00">
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-md-6 col-lg-2 mol-2">
                    ...
                    <input type="text" class="form-control jod" name="bill_saman_tax[]" placeholder="TAX" value="<?php
    ...
    <span class="input-group-addon"><?php
        ...
        ?></span>
                        <input type="text" class="form-control jod-sub" name="bill_saman_sub[]" id="bill_saman_sub[]"
                ...
                <div class="panel panel-primary">
                    ...
                    <div id="bill_totl" class=" panel panel-default padding-b">
                        ...
                        <div class="row margin-bottom padding">
                            ...
                            <div class="col-xs-4 text-right">
                                <div class="input-group">
                                    <input type="text" class="form-control jod vvt" name="invoice_vvt"
...
function editq($id)
{
    ...
    $query = "SELECT *
			FROM returnc WHERE tid = '$getID' LIMIT 1";
    ...
    if ($result = $db->pdoQuery($query)->results()) {
        ...
        <form method="post" id="edit_quote" class="fmargin">
            ...
            <div class="row panel panel-default" id="saman_list">
                ...
                $query2 = "SELECT * FROM return_items WHERE tid = '$getID'";
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#qlist').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "request/listitem.php?page=return"
            });
        });</script>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Manage Return Receipts</div>
                <div class="panel-body tbl"><p>Returned stock and its customer records</p>
                    <div class="table-responsive">
                        <table id="qlist" class="table cell-border" cellspacing="0">
                            <thead>
                            <tr>
                                <th>No</th>
                                <th>Date</th>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#qlist').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "request/listitem.php?page=ilist"
            });
        });</script>
    <div class="row">
        <div class="col-lg-12">
