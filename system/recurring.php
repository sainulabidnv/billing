 ...
 * ***********************************************************************
 */
if (stristr(htmlentities($_SERVER['PHP_SELF']), "recurring.php")) {
...
function create()
{
    ...
    {
        global $db;
        $row = $db->select('rec_invoices', null, null, 'ORDER BY tid DESC')->results();
        if ($row) {
            echo $row['tid'] + 1;
        }
    }
    ...
    <form method="post" id="create_quote" class="fmargin">
        ...
        <div class="row ">
            ...
            <div class="panel panel-primary ">
                <div class="panel-body chead">
                    <div class="col-md-6">
                        <h3>New Recurring Invoice</h3></div>
                    <div class="col-md-2">
        ...
        <div class="row bg-light-blue color-palette margin-t padding-f">
            ...
            <div class="ol-xs-12 col-md-3 col-lg-4 mol-4"><a href="#" class="btn btn-warning btn-xs add-row"><span
                            class="icon-plus"></span><strong>Add empty</strong></a> SERVICES ROW
            </div>
            <div class="col-xs-12 col-md-6 col-lg-1 mol-1">QTY</div>
            <div class="col-xs-12 col-md-6 col-lg-2 mol-2">UNIT PRICE</div>
            <div class="col-xs-12 col-md-6 col-lg-2 mol-1">SGST</div>
            <div class="col-xs-12 col-md-6 col-lg-2 mol-1">CGST</div>
            <div class="col-xs-12 col-md-6 col-lg-2 mol-1" style="border-right:0">SUBTOTAL</div>
        ...
        <div class="row panel panel-default" id="saman_list">
            ...
            <article class="mr6 margin-b">
                <div class="col-xs-12 col-md-3 col-lg-4 mol-4">
                    <div class="input-group">
    <span class="input-group-addon">
    ...
    <span class="input-group-addon currenty"><?php
        ...
        ?></span>
                ...
                <div class="col-xs-12 col-md-3 col-lg-1 mol-1">
                    ...
                    <input type="number" class="form-control pdtax jod" name="bill_saman_tax[]" placeholder="SGST"
                           value="<?php

                           echo $siteConfig['vatrate']

                           ?>">
                    <input type="hidden" class="form-control jod" name="saman-tax[]" placeholder="SGST" value="">
                ...
                <div class="col-xs-12 col-md-3 col-lg-1 mol-1">
                    ...
                    <input type="number" class="form-control pdtax2 jod" name="bill_saman_tax2[]" placeholder="CGST"
                           value="<?php

                           echo $siteConfig['vatrate2']

                           ?>">
                    <input type="hidden" class="form-control jod" name="saman-tax2[]" placeholder="CGST" value="">
                    ...
                    <div id="bill_totl" class=" panel panel-default padding-b">
                        ...
                        <div class="row">
                            <div class="col-xs-8 text-right "><br>
                                <strong>Repeat on every:</strong>
                            </div>
                            <div class="col-xs-4 text-right margin-t">
                                <select name="invoice_re" id="invoice_re" class="form-control">
                                    <option value="1" selected>7 Days</option>
                                    <option value="2">15 Days</option>
                                    <option value="3">30 Days</option>
                                    <option value="4">3 Moths</option>
                                    <option value="5">6 Months</option>
                                    <option value="6">12 Months</option>
                                    <option value="7">36 Months</option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
        ...
        <div class="row  panel panel-default padding-f">
            ...
            <div class="col-md-6 btn-group">
                <div class="row">
                    ...
                    <div class="col-xs-4 text-right margin-t"><input type="submit" id="action_create_rec"
                                                                     class="btn btn-success float-right" value="Create"
                                                                     data-loading-text="Creating..."></div>
                </div>
            </div>
...
function editq($id)
{
    ...
    $query = "SELECT * FROM rec_invoices WHERE tid = '$getID' LIMIT 1";
            ...
            foreach ($result2 as $rows) {
                ...
                <article class="mr6 margin-b">
                    ...
                    <div class="col-xs-12 col-md-3 col-lg-1 mol-1">
                        ...
                        ?>">
                        <input type="hidden" class="form-control jod" name="saman-tax[]" placeholder="TAX" value="<?php
                    ...
                    <div class="col-xs-12 col-md-3 col-lg-1 mol-1">
                        ...
                        <input type="text" class="form-control jod" name="bill_saman_tax2[]" placeholder="<?php
            ...
            <div class=" col-md-6">
                ...
                <div class="panel panel-primary">
                    ...
                    <div id="bill_totl" class=" panel panel-default padding-b">
                        ...
                        <div class="row margin-bottom padding">
                            <div class="col-xs-8 text-right">
                                <br>Remove TAX <input type="checkbox" class="remove_tax">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-right margin-t">
                                <select name="invoice_re" id="invoice_re" class="form-control">
                                    <?php
                                    switch ($rperiod) {
                                        case 1:
                                    ...
                                    echo " <option value='$rperiod'>Selected  $rc_next</option>";
                                    ?>
        ...
        <div class="row  panel panel-default padding-f">
            ...
            <div class="col-md-6 btn-group">
                <div class="row">
                    ...
                    <div class="col-xs-4 text-right margin-t"><input type="submit" id="raction_edit"
                                                                     class="btn btn-success float-right" value="Update"
                                                                     data-loading-text="Updating..."></div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#qlistr').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "request/listrecinvoice.php"
            });
        });</script>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Manage Quotes</div>
                <div class="panel-body tbl">
                    <table id="qlistr" class="table-responsive cell-border" cellspacing="0">
                        <thead>
                        <tr>
                            <th>#Invoice</th>
                            <th>Date</th>
