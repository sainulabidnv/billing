 ...
 * ***********************************************************************
 */
if (stristr(htmlentities($_SERVER['PHP_SELF']), "quote.php")) {
...
function create()
{
    ...
    {
        global $db;
        $row = $db->select('quote', null, null, 'ORDER BY tid DESC')->results();
        if ($row) {
            echo $row['tid'] + 1;
        }
    }
                    ...
                    <div class="col-md-2 float-right">
                        ...
                        <div class="input-group ">
                            ...
                            <input type="number" name="invoice_id" id="invoice_id" class="form-control required"
                                   placeholder="Quote Number" aria-describedby="sizing-addon1" value="<?php
    ...
    <span class="input-group-addon"><?php
        ...
        <div class="row  panel panel-default padding-f">
            ...
            <div class="col-md-6 btn-group">
                <input type="submit" id="action_create_quote" class="btn btn-success float-right" value="Create Quote"
    ...
    if ($result = $db->pdoQuery($query)->results()) {
        ...
        foreach ($result as $row) {
            ...
            if ($cidd > 0) {
                ...
                $row1 = $db->select('quote_customers', null, $whereConditions)->results();
        ...
        <form method="post" id="edit_quote" class="fmargin">
            ...
            <div class="row panel panel-default" id="saman_list">
                ...
                $query2 = "SELECT * FROM quote_items WHERE tid = '$getID'";
                ...
                foreach ($result2 as $rows) {
                    ...
                    <article class="mr6 margin-b">
                        ...
                        <div class="col-xs-12 col-md-3 col-lg-1 mol-1">
                            ...
                            ?>">
                            <input type="hidden" class="form-control jod" name="saman-tax[]" placeholder="SGST"
                                   value="<?php
                        ...
                        <div class="col-xs-12 col-md-3 col-lg-1 mol-1">
                            ...
                            ?>">
                            <input type="hidden" class="form-control jod" name="saman-tax2[]" placeholder="CGST"
                                   value="<?php
                ...
                <div class="col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body form-group form-group-sm" id="myc">
                            ...
                            <div class="form-group no-margin-bottom">
                                <a href="#" class="grahk-select btn btn-success">Select existing customer</a>&nbsp;
                                <input
            ...
            <div class="row  panel panel-default padding-f">
                ...
                <div class="col-md-6 btn-group">
                    <input type="submit" id="action_edit_quote" class="btn btn-success float-right" value="Update Quote"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#qlist').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": "request/listbills.php?page=quote"
            });
        });</script>
    <div class="row">
        <div class="col-lg-12">
